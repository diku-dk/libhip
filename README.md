...
We further crop the CT scans to the hip joint area to minimize the computational load during segmentation and store the in NIFTI format. The cropped CT scans are located in the [image_data](https://github.com/diku-dk/libhip/tree/main/models/image_data) folder.
